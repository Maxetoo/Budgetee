    ...
    let analysis = [
      {
        ...
        totalValue: parseInt((item.foodSummary * item.expenses) / 100),
      },
      {
        id: 1,
        ...
        totalValue: parseInt((item.clothingSummary * item.expenses) / 100),
      },
      {
        id: 2,
        ...
        totalValue: parseInt((item.schoolExpSummary * item.expenses) / 100),
      },
      {
        id: 3,
        image: imageData.tp,
        ...
        totalValue: parseInt((item.tpSummary * item.expenses) / 100),
      },
      {
        id: 4,
        ...
        totalValue: parseInt((item.bf_gfSummary * item.expenses) / 100),
      },
      {
        id: 5,
        ...
        totalValue: parseInt((item.dataSummary * item.expenses) / 100),
      },
    ]
